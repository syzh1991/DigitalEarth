    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            Timer timer = new Timer(1000, new ActionListener()
            {
                ...
                {
                //	Sector s=(Sector)app.getWwd().getValue(AVKey.SECTOR_RESOLUTION_LIMIT);
        ...
        protected void initSwingComponents()
        {
            ...
            final AppFrame app=this;
            button.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent event)
                {
                	Sector s=(Sector)app.getWwd().getView().getValue(AVKey.SECTOR_RESOLUTION_LIMIT);
                	System.out.println(app.getWwd().getView().getCenterPoint());
                    viewController.gotoScene();
                }
            });
