...
public class RigidShapes extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected void makeShapes()
        {
            ...
            Cone cone = new Cone(Position.fromDegrees(37.5, -115, 800000), 200000, 400000, 200000);
    ...
    public static class Task extends TimerTask{
		...
		@Override
		public void run() {
		Cone cone=	AppFrame.cone;
		Position p=cone.getCenterPosition();
		Position pp=new Position(p.getLatitude(),p.getLongitude(),p.getAltitude()+2);
		cone.setCenterPosition(pp);
