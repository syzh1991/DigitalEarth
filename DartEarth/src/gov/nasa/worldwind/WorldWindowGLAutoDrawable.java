...
//        this.drawable.setGL(new DebugGL(this.drawable.getGL())); // uncomment to use the debug drawable
    ...
    public void display(GLAutoDrawable glAutoDrawable)
    {
        ...
        try
        {
            ...
            Position eyePositionAtStart = this.getView().getEyePosition();
            ...
            Position eyePositionAtEnd = this.getView().getEyePosition();
            if (eyePositionAtStart != null || eyePositionAtEnd != null)
            {
                // call the listener if both are not null or positions are the same
                if (eyePositionAtStart != null && eyePositionAtEnd != null)
                {
                    if (!eyePositionAtStart.equals(eyePositionAtEnd))
                        this.callViewMoveListeners(new ViewMoveEvent(this.drawable, sc.getPickPoint(),
                        	eyePositionAtStart, eyePositionAtEnd));
                }
                else
                {
                    this.callViewMoveListeners(new ViewMoveEvent(this.drawable, sc.getPickPoint(),
