...
public class ApplicationTemplate
{
    public static class AppPanel extends JPanel
    {
        ...
        public WorldWindowGLCanvas createWorldWindow()
        {
    ...
    {
        private Dimension canvasSize = new Dimension(960, 600);
        ...
        public void initialize(boolean includeStatusBar, boolean includeLayerPanel, boolean includeStatsPanel)
        {
        ...
        public AppPanel createAppPanel(Dimension canvasSize, boolean includeStatusBar)
        {
