 ...
 * 
 */
public class CopyOfLayerPanelDailog2 extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private String DEFAULT_TITLE = "选择图层";
	...
	public CopyOfLayerPanelDailog2(DartEarthAppFrame frame, String text, WorldWindow wwd) {
		super(frame, text);
	...
	//	System.out.println(wwd);
		...
		this.addWindowFocusListener(new WindowFocusListener() {
			...
			public void windowGainedFocus(WindowEvent arg0) {
				AWTUtilities.setWindowOpacity(CopyOfLayerPanelDailog2.this, 1f);
			}

			@Override
			public void windowLostFocus(WindowEvent arg0) {
				AWTUtilities.setWindowOpacity(CopyOfLayerPanelDailog2.this, 0.7f);
			}
		});
	}
