...
public enum ESearchField {
	 ...
	 */
	SCENEROW("sceneRow"),
	FROMSCENEROW("fromSceneRow"),
	TOSCENEROW("toSceneRow"),
	/**
	 * 景路
	 */
	SCENEPATH("scenePath"),
	FROMSCENEPATH("fromScenePath"),
	TOSCENEPATH("toScenePath"),
	/**
	 * 卫星
	 */
	...
	FROMPRODUCTDATE("fromProductDate"),
	TOPRODUCTDATE("toProductDate"),
	/**
	 * 产品等级
	 */
	 ...
	 * 左上经度
	 */
	DATAUPPERLEFTLONG("dataUpperLeftLong"),
	/**
	 * 左上纬度
	 */
	 ...
	 * 当前页面的数据覆盖率
	 */
	CURRENTCOVERRATIO("currentCoverRatio");
	
	private String field;

	private ESearchField(String field) {
		this.field = field;
	}
